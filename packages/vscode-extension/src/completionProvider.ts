        ...
        const keywords = [
            {
                ...
                description:
                    'Material or immaterial goods that are created by one or more processes',
        ...
        const operators = [
            {
                label: '-->',
                description:
                    'Flow connection - connects process operators with products, energy, or information',
                detail: 'Flow connection operator',
            },
            {
                label: '-.->',
                description:
                    'Alternative flow connection - represents alternative or conditional flows',
            ...
            },
            {
                label: '<..>',
                description:
                    'Usage connection - connects technical resources or information to process operators',
